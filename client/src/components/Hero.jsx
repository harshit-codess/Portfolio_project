    ...
    return (
        <>
            <div id="portfolio" className='flex'>
                <div className="content mx-[10%] my-[40%] sm:my-[25%] md:my-[18%] text-white text-lg md:text-2xl lg:text-4xl">
                    ...
                    <Link href='https://drive.google.com/file/d/1zrONSJR6kyCsJSSm_D87qgwqEwkSqODa/view?usp=sharing'><button className='text-[#F2B56B] border-4 border-[#F2B56B] rounded-[0.5vw]  mt-5 px-4 py-2 text-base '>View Resume</button></Link>
                </div>
            ...
            <div className="socialMedia flex flex-col text-2xl gap-2 text-amber-50 fixed top-[60%] left-[90%] md:left-[95%] z-50">
